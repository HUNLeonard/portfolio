...
const Navbar = () => {
  ...
  return (
    <header className={`fixed top-6 left-0 right-0 mx-auto max-w-[1440px] h-16 bg-linear-20 from-gray-800 to-gray-900 md:rounded-md transition-all ease-in-out duration-200 ${isScroll ? 'translate-y-0' : '-translate-y-6 !rounded-t-none'} z-50`}>
      <nav className='flex justify-between items-center px-2 md:px-5 h-full gap-6'>
